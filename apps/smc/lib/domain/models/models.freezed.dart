...
HomeTreatmentPlan _$HomeTreatmentPlanFromJson(Map<String, dynamic> json) {
  return _HomeTreatmentPlan.fromJson(json);
}

/// @nodoc
mixin _$HomeTreatmentPlan {
  Map<String, Prescription> get homeTreatment =>
      throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $HomeTreatmentPlanCopyWith<HomeTreatmentPlan> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $HomeTreatmentPlanCopyWith<$Res> {
  factory $HomeTreatmentPlanCopyWith(
          HomeTreatmentPlan value, $Res Function(HomeTreatmentPlan) then) =
      _$HomeTreatmentPlanCopyWithImpl<$Res, HomeTreatmentPlan>;
  @useResult
  $Res call({Map<String, Prescription> homeTreatment});
}

/// @nodoc
class _$HomeTreatmentPlanCopyWithImpl<$Res, $Val extends HomeTreatmentPlan>
    implements $HomeTreatmentPlanCopyWith<$Res> {
  _$HomeTreatmentPlanCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      homeTreatment: null == homeTreatment
          ...
          : homeTreatment // ignore: cast_nullable_to_non_nullable
              as Map<String, Prescription>,
    ) as $Val);
  }
}

/// @nodoc
abstract class _$$HomeTreatmentPlanImplCopyWith<$Res>
    implements $HomeTreatmentPlanCopyWith<$Res> {
  factory _$$HomeTreatmentPlanImplCopyWith(_$HomeTreatmentPlanImpl value,
          $Res Function(_$HomeTreatmentPlanImpl) then) =
      __$$HomeTreatmentPlanImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({Map<String, Prescription> homeTreatment});
}
...
/// @nodoc
class __$$HomeTreatmentPlanImplCopyWithImpl<$Res>
    extends _$HomeTreatmentPlanCopyWithImpl<$Res, _$HomeTreatmentPlanImpl>
    implements _$$HomeTreatmentPlanImplCopyWith<$Res> {
  __$$HomeTreatmentPlanImplCopyWithImpl(_$HomeTreatmentPlanImpl _value,
      $Res Function(_$HomeTreatmentPlanImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$HomeTreatmentPlanImpl(
      homeTreatment: null == homeTreatment
          ? _value._homeTreatment
          : homeTreatment // ignore: cast_nullable_to_non_nullable
              as Map<String, Prescription>,
    ));
  }
...
class _$HomeTreatmentPlanImpl implements _HomeTreatmentPlan {
  ...
  factory _$HomeTreatmentPlanImpl.fromJson(Map<String, dynamic> json) =>
      _$$HomeTreatmentPlanImplFromJson(json);

  final Map<String, Prescription> _homeTreatment;
  @override
  Map<String, Prescription> get homeTreatment {
    if (_homeTreatment is EqualUnmodifiableMapView) return _homeTreatment;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_homeTreatment);
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._homeTreatment, _homeTreatment));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_homeTreatment));

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$HomeTreatmentPlanImplCopyWith<_$HomeTreatmentPlanImpl> get copyWith =>
      __$$HomeTreatmentPlanImplCopyWithImpl<_$HomeTreatmentPlanImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$HomeTreatmentPlanImplToJson(
      this,
    );
  }
}

abstract class _HomeTreatmentPlan implements HomeTreatmentPlan {
  const factory _HomeTreatmentPlan(
          {required final Map<String, Prescription> homeTreatment}) =
      _$HomeTreatmentPlanImpl;

  factory _HomeTreatmentPlan.fromJson(Map<String, dynamic> json) =
      _$HomeTreatmentPlanImpl.fromJson;
...
abstract class _Medicine implements Medicine {
  const factory _Medicine({required final String medicine}) = _$MedicineImpl;
...
mixin _$Staff {
  ...
  StaffType get staffType => throw _privateConstructorUsedError;
  String get name => throw _privateConstructorUsedError;
  int get payScale => throw _privateConstructorUsedError;
...
abstract class $StaffCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, StaffType staffType, String name, int payScale});
}
    ...
    return _then(_value.copyWith(
      ...
      name: null == name
          ...
          : name // ignore: cast_nullable_to_non_nullable
              as String,
      payScale: null == payScale
          ? _value.payScale
          : payScale // ignore: cast_nullable_to_non_nullable
              as int,
    ) as $Val);
  }
}
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.payScale, payScale) ||
                other.payScale == payScale));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, staffType, name, payScale);
...
abstract class _Staff extends Staff {
  const factory _Staff(
      ...
      required final int payScale}) = _$StaffImpl;
...
abstract class $PrescriptionCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, Medicine medicine, String dose, String instructions});
...
class _$PrescriptionImpl implements _Prescription {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, medicine, dose, instructions);
...
abstract class _Prescription implements Prescription {
  const factory _Prescription(
      ...
      required final String instructions}) = _$PrescriptionImpl;
