...
class RegisterForm extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    final emailID = useTextEditingController();
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: ElevatedButton.icon(
                            onPressed: () {
                              // registerForm.isValid ? registerForm.submit : null;
                              ref.read(usersProvider.notifier).addUser(name.text, emailID.text, password.text);
                            },
